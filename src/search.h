...
struct PVMoves {
    ...
    PVMoves(const PVMoves& other) {
        length = other.length;
        std::memcpy(moves, other.moves, length * sizeof(Move));
    }

    PVMoves& operator=(const PVMoves& other) {
        if (this != &other)
        {
            length = other.length;
            std::memcpy(moves, other.moves, length * sizeof(Move));
    ...
    PVMoves(PVMoves&& other) noexcept {
        length = other.length;
        std::memcpy(moves, other.moves, length * sizeof(Move));
        other.length = 0;
    }

    PVMoves& operator=(PVMoves&& other) noexcept {
        if (this != &other)
        {
            length = other.length;
            std::memcpy(moves, other.moves, length * sizeof(Move));
